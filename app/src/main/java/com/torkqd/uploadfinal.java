...
public class uploadfinal extends Activity {
    ListView videolist;
    ListView imagelist;
    int count;
    int counti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileurl=fileurl.valueOf(fileurl);
        if(fileurl!=null){

            dialog = ProgressDialog.show(uploadfinal.this,
    ...
    public static void startuploader1(Context context ,String url){
        ...
        uploadfinal nup=new uploadfinal();
    ...
    class VideoUploadTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... unsued) {
            ...
            try {
                ...
                Context context = uploadfinal.this;
