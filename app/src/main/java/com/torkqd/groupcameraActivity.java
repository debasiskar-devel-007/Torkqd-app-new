...
public class groupcameraActivity extends Activity {
    ...
    public static groupcameraActivity ActivityContext =null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        super.setContentView(R.layout.group_camera_activity);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bitmap == null && bitmap1==null) {
                    ...
                    dialog = ProgressDialog.show(groupcameraActivity.this,
    ...
    class ImageUploadTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... unsued) {
            ...
            try {
                ...
                Context context = groupcameraActivity.this;
