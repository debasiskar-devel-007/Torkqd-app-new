...
public class videoplayerActivity extends Activity {
    ...
    public static videoplayerActivity ActivityContext = null;
    String fileuri = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.video_activityplayer);
        ...
        vlocalfileuril = intent.getStringExtra("fileuri");
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileuri == null ) {
                    ...
                    dialog = ProgressDialog.show(videoplayerActivity.this,
